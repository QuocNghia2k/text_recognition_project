...
class TextConvertToImagePage extends StatefulWidget {
  final TextConvertBloc bloc;

  TextConvertToImagePage(this.bloc, {Key? key}) : super(key: key);

  @override
  State<TextConvertToImagePage> createState() => _TextConvertToImagePageState();
}

class _TextConvertToImagePageState extends BaseState<TextConvertToImagePage, TextConvertBloc> {
